...
public class InputMapper {
    public static final Map<Integer, InputAction> DEFAULT_BINDINGS = Map.ofEntries(
            ...
            // player
            Map.entry(GLFW_KEY_1, new InputAction.HotbarAction.Select(0)),
            Map.entry(GLFW_KEY_2, new InputAction.HotbarAction.Select(1)),
            Map.entry(GLFW_KEY_3, new InputAction.HotbarAction.Select(2)),
            Map.entry(GLFW_KEY_4, new InputAction.HotbarAction.Select(3)),
            Map.entry(GLFW_KEY_5, new InputAction.HotbarAction.Select(4)),
            Map.entry(GLFW_KEY_6, new InputAction.HotbarAction.Select(5)),
            Map.entry(GLFW_KEY_7, new InputAction.HotbarAction.Select(6)),
            Map.entry(GLFW_KEY_8, new InputAction.HotbarAction.Select(7)),
            Map.entry(GLFW_KEY_9, new InputAction.HotbarAction.Select(8)),
